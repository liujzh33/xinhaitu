...
class MultiSourcePretrainDataset(data.Dataset):
    ...
    def _load_action(self, qpos_path: str, action_indices: List[int], initial_state_idx: int) -> Tuple[torch.Tensor, torch.Tensor]:
    ...
    def __getitem__(self, idx: int) -> Optional[Dict[str, Any]]:
        ...
        for _ in range(max_attempts):
            ...
            try:
                ...
                initial_state, action_sequence = self._load_action(episode_data['qpos_path'], action_indices, condition_frame_idx)
