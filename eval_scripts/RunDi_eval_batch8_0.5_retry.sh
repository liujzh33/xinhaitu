#!/bin/bash
# Eval script for: batch8_0.5_retry
...
# ============================================================================
CKPT_OBS_BASE="obs://yw-2030-gy/external/wwx1513998/checkpoint/motus_robotwin_subtask_Motus_threeclip_20w_batch8_0.5_retry"
RUN_TAG="batch8_0.5_retry"
