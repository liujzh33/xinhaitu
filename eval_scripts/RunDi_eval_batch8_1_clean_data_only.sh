#!/bin/bash
# Eval script for: batch8_1_clean_data_only
...
# ============================================================================
CKPT_OBS_BASE="obs://yw-2030-gy/external/wwx1513998/checkpoint/motus_robotwin_subtask_Motus_threeclip_20w_batch8_1_clean_data_only"
RUN_TAG="batch8_1_clean_data_only"
