#!/bin/bash
# Eval script for: batch8_1_retry
# Checkpoints (in test order): best_action_l2 -> step_80k -> step_60k -> step_40k -> step_20k
# 5 checkpoints total (no step_100k), each tested sequentially
...
# ============================================================================
CKPT_OBS_BASE="obs://yw-2030-gy/external/wwx1513998/checkpoint/motus_robotwin_subtask_Motus_threeclip_20w_batch8_1_retry"
RUN_TAG="batch8_1_retry"
