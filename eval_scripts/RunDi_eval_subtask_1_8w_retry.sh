#!/bin/bash
# Eval script for: subtask_1_8w_retry (品字型, 4-node, subtask_weight=1)
# Purpose: Verify (1) longer training effect, (2) subtask weight impact
# Uses ORIGINAL 品字型 RoboTwin code (not robotwin_threeclip)
# Checkpoints (in test order): best_action_l2 -> step_120k -> 100k -> 80k -> 60k -> 40k -> 20k
# 7 checkpoints total, each tested sequentially
...
# Use ORIGINAL RoboTwin (品字型 deploy_policy.py), NOT robotwin_threeclip
...
# ============================================================================
CKPT_OBS_BASE="obs://yw-2030-gy/external/wwx1513998/checkpoint/motus_robotwin_subtask_train_RunDi_RoboTwin_4_subtask_1_8w_retry"
RUN_TAG="subtask_1_8w_retry"

CKPT_LIST=(
    "best_action_l2"
    "checkpoint_step_120000"
...
echo "Purpose: (1) Longer training effect (2) Subtask weight impact"
echo "========================================================="
