...
# Increase NCCL timeout to prevent false timeout during long operations (e.g., checkpoint saving)
os.environ["TORCH_NCCL_TIMEOUT"] = "1800"  # 30 minutes
os.environ["TORCH_NCCL_HEARTBEAT_TIMEOUT_SEC"] = "1800"  # 30 minutes
# Disable NCCL monitoring watchdog that can falsely abort after long hangs
os.environ["TORCH_NCCL_ENABLE_MONITORING"] = "0"
# Enable NCCL async error handling
os.environ["NCCL_ASYNC_ERROR_HANDLING"] = "1"
# NCCL debug info (comment out for production)
...
class MotusWanVlmTrainer:
    ...
    def train_step(self, batch: Dict[str, Any]) -> Dict[str, float]:
        ...
        # Optional action_dim_is_pad mask (excludes padded dims from action loss)
