...
from models.motus_wan_vlm_direct_mask_initaction import MotusWanVlmDirectMask, MotusWanVlmDirectMaskConfig
...
def create_model_and_optimizer(config: OmegaConf) -> tuple:
    ...
    model_config = MotusWanVlmDirectMaskConfig(
        ...
        action_pretrained_path=getattr(config.model.action_expert, 'pretrained_path', ""),
