...
from models.motus_wan_vlm_direct_soft import MotusWanVlmDirect, MotusWanVlmDirectConfig
...
def create_model_and_optimizer(config: OmegaConf) -> tuple:
    ...
    model_config = MotusWanVlmDirectConfig(
        ...
        use_learnable_alignment=getattr(config.model.qwen3_expert, 'use_learnable_alignment', False),
        alignment_temperature=getattr(config.model.qwen3_expert, 'alignment_temperature', 1.0),
        alignment_temperature_decay=getattr(config.model.qwen3_expert, 'alignment_temperature_decay', False),
        alignment_init_identity=getattr(config.model.qwen3_expert, 'alignment_init_identity', False),
        # Other settings
